...
python -m portfolio.gen_data --n 100 --n_iter 1000 --deg 4

python -m portfolio.gen_data --n 100 --n_iter 1000 --deg 4 --n_train 1000 --n_validation 250

# python -m knapsack.run_experiments --keep 3 --diff IMLE --method LD --ep 1000000 --tl 10800
