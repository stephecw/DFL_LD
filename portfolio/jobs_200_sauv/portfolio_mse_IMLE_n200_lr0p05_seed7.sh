...
#SBATCH --mem=4G
#SBATCH --job-name=portfolio_mse_IMLE_n200_lr0p05_seed7
#SBATCH --output=logs/portfolio_mse_IMLE_n200_lr0p05_seed7.out
#SBATCH --error=logs/portfolio_mse_IMLE_n200_lr0p05_seed7.err
