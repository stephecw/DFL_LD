...
#SBATCH --mem=4G
#SBATCH --job-name=portfolio_cla_IMLE_n200_lr0p1_seed6
#SBATCH --output=logs/portfolio_cla_IMLE_n200_lr0p1_seed6.out
#SBATCH --error=logs/portfolio_cla_IMLE_n200_lr0p1_seed6.err
