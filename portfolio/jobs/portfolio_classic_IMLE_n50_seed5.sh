...
#SBATCH --mem=8G
#SBATCH --job-name=portfolio_classic_IMLE_n50_seed5
#SBATCH --output=logs/portfolio_classic_IMLE_n50_seed5.out
#SBATCH --error=logs/portfolio_classic_IMLE_n50_seed5.err
