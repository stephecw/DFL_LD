...
#SBATCH --mem=8G
#SBATCH --job-name=portfolio_SG_Exact_n50_sm20_ni20_seed1
#SBATCH --output=logs/portfolio_SG_Exact_n50_sm20_ni20_seed1.out
#SBATCH --error=logs/portfolio_SG_Exact_n50_sm20_ni20_seed1.err
