...
#SBATCH --mem=8G
#SBATCH --job-name=portfolio_classic_IMLE_n50_seed1
#SBATCH --output=logs/portfolio_classic_IMLE_n50_seed1.out
#SBATCH --error=logs/portfolio_classic_IMLE_n50_seed1.err
