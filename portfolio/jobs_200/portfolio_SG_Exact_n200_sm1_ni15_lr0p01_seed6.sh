...
#SBATCH --mem=4G
#SBATCH --job-name=portfolio_SG_Exact_n200_sm1_ni15_lr0p01_seed6
#SBATCH --output=logs/portfolio_SG_Exact_n200_sm1_ni15_lr0p01_seed6.out
#SBATCH --error=logs/portfolio_SG_Exact_n200_sm1_ni15_lr0p01_seed6.err
