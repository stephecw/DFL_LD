...
#SBATCH --mem=4G
#SBATCH --job-name=portfolio_SG_Exact_n200_sm30_ni1_lr0p01_seed3
#SBATCH --output=logs/portfolio_SG_Exact_n200_sm30_ni1_lr0p01_seed3.out
#SBATCH --error=logs/portfolio_SG_Exact_n200_sm30_ni1_lr0p01_seed3.err
