...
#SBATCH --mem=8G
#SBATCH --job-name=portfolio_SG_Exact_lr0p001_muloss
#SBATCH --output=logs/portfolio_SG_Exact_lr0p001_muloss.out
#SBATCH --error=logs/portfolio_SG_Exact_lr0p001_muloss.err
