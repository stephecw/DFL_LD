...
#SBATCH --mem=4G
#SBATCH --job-name=portfolio_SG_Exact_n400_sm5_ni10_lr1p0_seed0
#SBATCH --output=logs/portfolio_SG_Exact_n400_sm5_ni10_lr1p0_seed0.out
#SBATCH --error=logs/portfolio_SG_Exact_n400_sm5_ni10_lr1p0_seed0.err
