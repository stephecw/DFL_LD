...
#SBATCH --mem=4G
#SBATCH --job-name=portfolio_LD_Exact_n400_lr0p01_seed6
#SBATCH --output=logs/portfolio_LD_Exact_n400_lr0p01_seed6.out
#SBATCH --error=logs/portfolio_LD_Exact_n400_lr0p01_seed6.err
