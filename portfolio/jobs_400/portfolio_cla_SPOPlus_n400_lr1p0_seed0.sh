...
#SBATCH --mem=4G
#SBATCH --job-name=portfolio_cla_SPOPlus_n400_lr1p0_seed0
#SBATCH --output=logs/portfolio_cla_SPOPlus_n400_lr1p0_seed0.out
#SBATCH --error=logs/portfolio_cla_SPOPlus_n400_lr1p0_seed0.err
