...
#SBATCH --mem=4G
#SBATCH --job-name=portfolio_mse_IMLE_n400_lr0p005_seed6
#SBATCH --output=logs/portfolio_mse_IMLE_n400_lr0p005_seed6.out
#SBATCH --error=logs/portfolio_mse_IMLE_n400_lr0p005_seed6.err
