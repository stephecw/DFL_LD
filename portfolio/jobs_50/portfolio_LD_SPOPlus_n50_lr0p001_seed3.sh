...
#SBATCH --mem=4G
#SBATCH --job-name=portfolio_LD_SPOPlus_n50_lr0p001_seed3
#SBATCH --output=logs/portfolio_LD_SPOPlus_n50_lr0p001_seed3.out
#SBATCH --error=logs/portfolio_LD_SPOPlus_n50_lr0p001_seed3.err
