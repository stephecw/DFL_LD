...
#SBATCH --mem=4G
#SBATCH --job-name=portfolio_cla_IMLE_n50_lr1p0_seed7
#SBATCH --output=logs/portfolio_cla_IMLE_n50_lr1p0_seed7.out
#SBATCH --error=logs/portfolio_cla_IMLE_n50_lr1p0_seed7.err
