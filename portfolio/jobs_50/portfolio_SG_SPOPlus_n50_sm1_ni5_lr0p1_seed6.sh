...
#SBATCH --mem=4G
#SBATCH --job-name=portfolio_SG_SPOPlus_n50_sm1_ni5_lr0p1_seed6
#SBATCH --output=logs/portfolio_SG_SPOPlus_n50_sm1_ni5_lr0p1_seed6.out
#SBATCH --error=logs/portfolio_SG_SPOPlus_n50_sm1_ni5_lr0p1_seed6.err
