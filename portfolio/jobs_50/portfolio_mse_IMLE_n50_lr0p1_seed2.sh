...
#SBATCH --mem=4G
#SBATCH --job-name=portfolio_mse_IMLE_n50_lr0p1_seed2
#SBATCH --output=logs/portfolio_mse_IMLE_n50_lr0p1_seed2.out
#SBATCH --error=logs/portfolio_mse_IMLE_n50_lr0p1_seed2.err
