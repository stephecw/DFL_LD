...
#SBATCH --mem=4G
#SBATCH --job-name=portfolio_cla_IMLE_n50_lr1p0_seed3
#SBATCH --output=logs/portfolio_cla_IMLE_n50_lr1p0_seed3.out
#SBATCH --error=logs/portfolio_cla_IMLE_n50_lr1p0_seed3.err
