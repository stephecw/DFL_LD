...
#SBATCH --mem=4G
#SBATCH --job-name=portfolio_cla_SPOPlus_n50_lr0p005_seed3
#SBATCH --output=logs/portfolio_cla_SPOPlus_n50_lr0p005_seed3.out
#SBATCH --error=logs/portfolio_cla_SPOPlus_n50_lr0p005_seed3.err
