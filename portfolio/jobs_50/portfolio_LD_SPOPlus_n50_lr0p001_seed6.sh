...
#SBATCH --mem=4G
#SBATCH --job-name=portfolio_LD_SPOPlus_n50_lr0p001_seed6
#SBATCH --output=logs/portfolio_LD_SPOPlus_n50_lr0p001_seed6.out
#SBATCH --error=logs/portfolio_LD_SPOPlus_n50_lr0p001_seed6.err
