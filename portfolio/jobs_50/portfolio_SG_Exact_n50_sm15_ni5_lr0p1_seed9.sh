...
#SBATCH --mem=4G
#SBATCH --job-name=portfolio_SG_Exact_n50_sm15_ni5_lr0p1_seed9
#SBATCH --output=logs/portfolio_SG_Exact_n50_sm15_ni5_lr0p1_seed9.out
#SBATCH --error=logs/portfolio_SG_Exact_n50_sm15_ni5_lr0p1_seed9.err
