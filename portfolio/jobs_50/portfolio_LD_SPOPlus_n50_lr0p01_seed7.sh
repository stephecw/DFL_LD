...
#SBATCH --mem=4G
#SBATCH --job-name=portfolio_LD_SPOPlus_n50_lr0p01_seed7
#SBATCH --output=logs/portfolio_LD_SPOPlus_n50_lr0p01_seed7.out
#SBATCH --error=logs/portfolio_LD_SPOPlus_n50_lr0p01_seed7.err
