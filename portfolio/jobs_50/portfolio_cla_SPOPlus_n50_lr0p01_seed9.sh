...
#SBATCH --mem=4G
#SBATCH --job-name=portfolio_cla_SPOPlus_n50_lr0p01_seed9
#SBATCH --output=logs/portfolio_cla_SPOPlus_n50_lr0p01_seed9.out
#SBATCH --error=logs/portfolio_cla_SPOPlus_n50_lr0p01_seed9.err
