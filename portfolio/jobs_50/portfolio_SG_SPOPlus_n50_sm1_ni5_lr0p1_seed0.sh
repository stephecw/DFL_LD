...
#SBATCH --mem=4G
#SBATCH --job-name=portfolio_SG_SPOPlus_n50_sm1_ni5_lr0p1_seed0
#SBATCH --output=logs/portfolio_SG_SPOPlus_n50_sm1_ni5_lr0p1_seed0.out
#SBATCH --error=logs/portfolio_SG_SPOPlus_n50_sm1_ni5_lr0p1_seed0.err
