...
#SBATCH --mem=4G
#SBATCH --job-name=portfolio_LD_Exact_n50_lr0p01_seed3
#SBATCH --output=logs/portfolio_LD_Exact_n50_lr0p01_seed3.out
#SBATCH --error=logs/portfolio_LD_Exact_n50_lr0p01_seed3.err
