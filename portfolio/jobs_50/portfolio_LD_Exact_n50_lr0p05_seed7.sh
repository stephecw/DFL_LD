...
#SBATCH --mem=4G
#SBATCH --job-name=portfolio_LD_Exact_n50_lr0p05_seed7
#SBATCH --output=logs/portfolio_LD_Exact_n50_lr0p05_seed7.out
#SBATCH --error=logs/portfolio_LD_Exact_n50_lr0p05_seed7.err
