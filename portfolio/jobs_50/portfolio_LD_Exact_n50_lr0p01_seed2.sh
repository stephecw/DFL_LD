...
#SBATCH --mem=4G
#SBATCH --job-name=portfolio_LD_Exact_n50_lr0p01_seed2
#SBATCH --output=logs/portfolio_LD_Exact_n50_lr0p01_seed2.out
#SBATCH --error=logs/portfolio_LD_Exact_n50_lr0p01_seed2.err
