...
#SBATCH --mem=4G
#SBATCH --job-name=portfolio_SG_Exact_n50_sm20_ni30_lr0p1_seed2
#SBATCH --output=logs/portfolio_SG_Exact_n50_sm20_ni30_lr0p1_seed2.out
#SBATCH --error=logs/portfolio_SG_Exact_n50_sm20_ni30_lr0p1_seed2.err
