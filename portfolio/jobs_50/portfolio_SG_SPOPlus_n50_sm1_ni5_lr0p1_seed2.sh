...
#SBATCH --mem=4G
#SBATCH --job-name=portfolio_SG_SPOPlus_n50_sm1_ni5_lr0p1_seed2
#SBATCH --output=logs/portfolio_SG_SPOPlus_n50_sm1_ni5_lr0p1_seed2.out
#SBATCH --error=logs/portfolio_SG_SPOPlus_n50_sm1_ni5_lr0p1_seed2.err
