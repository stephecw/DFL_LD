...
#SBATCH --mem=8G
#SBATCH --job-name=knapsack_SG_IMLE_n100_sm1_ni10_mains
#SBATCH --output=logs/knapsack_SG_IMLE_n100_sm1_ni10_mains.out
#SBATCH --error=logs/knapsack_SG_IMLE_n100_sm1_ni10_mains.err
