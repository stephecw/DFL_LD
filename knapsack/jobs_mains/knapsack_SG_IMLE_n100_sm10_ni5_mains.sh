...
#SBATCH --mem=8G
#SBATCH --job-name=knapsack_SG_IMLE_n100_sm10_ni5_mains
#SBATCH --output=logs/knapsack_SG_IMLE_n100_sm10_ni5_mains.out
#SBATCH --error=logs/knapsack_SG_IMLE_n100_sm10_ni5_mains.err
