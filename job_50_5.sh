...
#SBATCH --output=output_50_5.log     # Fichier de sortie
#SBATCH --error=error_50_5.log
...
python -m knapsack.run_experiments --n 50 --dim 5 --ep_cla -1 --ep_sg -1 --ep_ld -1 --ep_mse -1 --tl_cla 7200 --ep_ld 7200 --ep_mse 7200
